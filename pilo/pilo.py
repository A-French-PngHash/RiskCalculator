...
draw.text((100, 150), f"Nombre de vaisseaux capitaux du joueur 2 : {str(config.vaisseaux_j2[0])}", font=generalFont, fill=(0, 0, 0))
draw.text((100, 200), f"Nombre de chasseurs du joueur 1 : {str(config.vaisseaux_j1[2])}", font=generalFont, fill=(0, 0, 0))
draw.text((100, 250), f"Nombre de chasseurs du joueur 2 : {str(config.vaisseaux_j2[2])}", font=generalFont, fill=(0, 0, 0))
draw.text((100, 300), f"Nombre de bombardiers du joueur 1 : {str(config.vaisseaux_j1[1])}", font=generalFont, fill=(0, 0, 0))
draw.text((100, 350), f"Nombre de bombardiers du joueur 2 : {str(config.vaisseaux_j2[1])}", font=generalFont, fill=(0, 0, 0))
draw.text((100, 400), f"Nombre de troupes du joueur 1 : {str(config.nb_troupes_j1)}", font=generalFont, fill=(0, 0, 0))
draw.text((100, 450), f"Nombre de troupes du joueur 2 : {str(config.nb_troupes_j2)}", font=generalFont, fill=(0, 0, 0))
